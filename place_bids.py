...
from freelancersdk.resources.projects.exceptions import BidsNotFoundException
...
freelancer_oauth_token = "6qPaCcQps0q8piaVmryS7stkhwbW6c"
...
bid_description = '''
Hi, Client.
I have read your job posting carefully.
I have done various kinds of python app before such as controlling dymo 450 printer, amazon sp-api app, screen capturing app, etc.
